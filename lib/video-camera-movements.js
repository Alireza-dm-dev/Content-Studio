...
const STYLE_MOVEMENT_PREFERENCE = {
  ...
  // Cinematic visual styles (new)
  "anamorphic-blockbuster":   { families: ["dolly", "orbit", "jib", "static", "physical"], speedPref: "slow" },
  "neo-noir-thriller":        { families: ["dolly", "static", "tilt", "pan"], speedPref: "slow" },
  "vintage-35mm-film":        { families: ["static", "dolly", "pan", "tilt"], speedPref: "medium" },
  "luxury-commercial":        { families: ["orbit", "dolly", "static", "jib", "physical"], speedPref: "slow" },
  "dreamlike-surrealism":     { families: ["orbit", "dolly", "static", "complex"], speedPref: "slow" },
  "gritty-documentary":       { families: ["handheld", "static", "pan", "tilt", "follow"], speedPref: "medium" },
  "retro-futurist-scifi":     { families: ["dolly", "orbit", "jib", "static", "complex"], speedPref: "medium" },
  "epic-golden-hour":         { families: ["dolly", "orbit", "jib", "static", "physical"], speedPref: "slow" },
};
